...
module ApiGraphql
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['API_GRAPHQL_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load ApiGraphql::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time ApiGraphql::Action is included
      ...
      # Configure the code that will yield each time ApiGraphql::View is included
      # This is useful for sharing common functionality
      #
