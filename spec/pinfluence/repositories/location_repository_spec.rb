...
describe LocationRepository do
  ...
  describe "#by_moment" do
    ...
    let(:location_01) { Location.new(moment_id: moment_01.id, address: "Address", latlng: "0,0") }
    let(:location_02) { Location.new(moment_id: moment_01.id, address: "Address", latlng: "0,0") }
    let(:location_03) { Location.new(moment_id: moment_02.id, address: "Address", latlng: "0,0") }
